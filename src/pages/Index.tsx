...
export default function Index() {
  ...
  const handleRefreshAIValuation = async () => {
    ...
    // ★ 安全检查 3：确认弹窗（防止误触）
    const confirmMsg = `即将对 ${toEstimate.length} 台设备调用 AI 估值。\n` +
